  ...
  return (
    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-5xl bg-white p-8 rounded-xl flex gap-8">
      <div className="flex flex-col flex-2/4 justify-center">
        ...
        <h2 className="text-3xl text-blue font-bold">Contagem regressiva para a Temporada de Férias!</h2>
      </div>
      <div className="flex flex-3/4 gap-5">
        {timeUnits.map((unit, index) => (
          <div key={index} className="w-full shadow-soft rounded-xl flex flex-col items-center justify-center space-y-2 py-4">
            <h4 className="text-blue font-bold text-4xl">{String(unit.value).padStart(2, '0')}</h4>
