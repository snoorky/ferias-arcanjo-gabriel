...
export default function CookieConsentBanner() {
  ...
  const loadGTM = () => {
    ...
    gtmScript.innerHTML = `
      ...
      })(window,document,'script','dataLayer','GTM-M8MZ9MN7');
    `;
    document.head.appendChild(gtmScript);

    const gaScript = document.createElement("script");
    gaScript.src = "https://www.googletagmanager.com/gtag/js?id=G-VXELMC56WP";
    gaScript.async = true;
    ...
    noscript.innerHTML = `
      <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M8MZ9MN7"
